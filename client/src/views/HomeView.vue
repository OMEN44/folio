  ...
  <div class="div-about">
    <div class="div-about-content">
      ...
      <div class="div-right">
        <h2>Reach out</h2>
        <p>
          As both part of my studies and as a hobby I am always working on a new
          project or improving an old one. I am always looking for new
          opportunites to put my skills to use or answer questions you may have
          about one of the projects I showcase on this website, so feel free to
          send me a message with the button below!
        </p>
