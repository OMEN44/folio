  ...
  <div class="div-container">
    <div class="div-menu">
      ...
      <div class="div-menu-body">
        ...
        <div class="div-note" v-for="(element, index) in notes" @click="changeSelection"
          :class="{ highlight: index === selected }" :key="index">
          <h3>{{ element['title'] }}</h3>
    ...
    <div class="div-notes-content">
      ...
      <NoteEditor ref="editor" v-if="notes[selected] !== undefined" :raw-markdown="notes[selected].content"
        :editor-open="accessLevel" :id="notes[selected].id" :private="notes[selected].isPrivate"
        @note-deleted="deleteNote" @update-note="initNotes" />
    </div>
  </div>
</template>
