...
<template>
  <div class="div-welcome-container">
    ...
    <div class="div-welcome">
      ...
      <p>Any one who shares my passion for tech will know that no project is ever truly finished, there is always an
        optimisation of improvement to make! As such this website will continiue to grow as I embark on new challanges, so
        keep an eye out for updates and have fun exploring this site!</p>
    </div>
  </div>
  <div class="container">
